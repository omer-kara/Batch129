...
//    "Java is easy to learn" ==> 1 + 5 + 8 = 14
        ...
        //Example 7: Bir String'de "Java" kelimesinin ilk olarak kacinci index de kullanildighini gosteren kodu yaziniz.

        String u = "Ah Java vah Java sensiz olmuyor Java";

        //indexOf("Java") kullaniminda siz "Java" kelimesinin ilk gorunumundeki ilk harfin indexini alis olursunuz.

        int idxJava = u.indexOf("Java");
        System.out.println(idxJava);//3

        //indexOf() methodu olmayan characterler icin kullanilirsa her zaman "-1" verir.
        ...
        //Note:Bazi kodlarin bazi sartlara bagli olarak calismasi gerekir.(Hesap dogrulunu kontrol eder)
        //      Bazi kodlari bazi sartlara gore aktive etmek icin "if statement" kullanilir.
        //      If you study hard (Sart), you will learn Java {Sonuc}.

        //Example 10. Sayi pozitif ise ekrana yazdirin
        int num = 12;
        ...
        //Example 11. Sayi -1 ile 10 arasinda ekrana "Rakam" yazdiriniz.
        ...
        n = Math.abs(n);// bu sayiyi mutlak degerini alir.
