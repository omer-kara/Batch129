...
public class TreeMap01 {
    ...
    4) TreeMap 'lerin "key" lerinde "null" kullanilamaz. Ama "value" lerde istediginiz kadar kullanabilirsiniz.
     */
    public static void main(String[] args) {
        ...
        //"key" lere gore alfabetik sira yapti.
        System.out.println(stdAges2);//{Ali=21, Ayse=25, Kemal=19, Murat=22}

        long three = System.nanoTime();

        TreeMap<String, Integer> stdAges3 = new TreeMap<>();
        ...
        TreeMap<String, Integer> stdAges4 = new TreeMap<>(stdAges3);//HashMap ten TreeMap yapiyor
        System.out.println(stdAges4);

        long four = System.nanoTime();

        System.out.println("threeMap = " + (two - one));
        System.out.println("HashMap = " + (three - two));
        System.out.println("HashMap --> Tree Map : " + (four - three));
    }
}
