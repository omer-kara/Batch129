...
public class HashMapMechanism {
    ...
    16 tane "bucket(kova)" olusturur ve bu "bucket" lari 0 dan 15 kadar indexler.
    2) Siz entry eklemek icin "hm.put("Istanbul", 17000000);" kodunu yazdiginizda java;
            ...
            iii)Kalani index olarak kullanp, index'i kalana esit olan bucket'a bu entry'i yerlestirir.
            iv)Bucket'a "entry" eklenirken, Java o "bucket" icinde "LinkedList" yapisini kullanilir.
