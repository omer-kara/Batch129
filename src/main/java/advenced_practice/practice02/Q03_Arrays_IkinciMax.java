...
public class Q03_Arrays_IkinciMax {
    ...
    //1.Yol :
        Arrays.sort(arr);//sort buyukten kucuge siralamak icin kullanilir
        System.out.println(Arrays.toString(arr));
        System.out.println("min :"+ arr[0]+" max :"+ arr[arr.length-1]+ " secMax :" + arr[arr.length-2] );//lenght tam sayi gibi sayar
