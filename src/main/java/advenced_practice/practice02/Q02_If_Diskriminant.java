...
/*
   ...
   */
        ...
        System.out.println("Denklemin a,b be c katsayilarini sirasiyla giriniz");
        ...
        if (delta>0){
            double x1 = (-b + Math.sqrt(delta)) / (2*a);//sqrt==> karakök alma formulu
            ...
            System.out.println("Denklemin 2 kökü vardir: x1 =  " + x1 +", x2 ="+ x2);
                ...
                double x=-b/(2*a);
            System.out.println("Denkleminiz: "+a+"x² + "+b+"x + "+c+";");
            System.out.println("Denklemin 1 kökü vardir: x =" + x);
