...
public class LinkedHashSet01 {
    public static void main(String[] args) {
        ...
        //Siz ayni elemanini tekrar tekrar eklerseniz Java hata vermez, ama tekrarli (son) eklenen elemani "Set" e sadece bir kere koyar.
        artist.add("Tom");
        ...
        System.out.println(artist);//[Tom, Brad]==> 2 Tom dan sadece birini aldi. Tekrarsiz islem yapar.
