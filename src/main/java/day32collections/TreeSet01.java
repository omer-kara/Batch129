...
public class TreeSet01 {
    public static void main(String[] args) {
        ...
        long one = System.nanoTime();//calistirdiginiz milisecond verecek.
        ...
        System.out.println(hts);//[32, 3, 8, 25, 12]==> rastgele dizdi
        ...
        //      TreeSet'in negatif yonunden kurtulmak icin, hashSet olusturur elemanlari ekler, ve sonra HashSet'i TreeSet'e ceviririz.
        ...
        System.out.println(ceiling1);//25==> 15 elemanlardan biri degil o yuzden 25 den bir onceki eleman yazdirdi.

        //ceiling() methodunda kullanabileceginiz sayi en buyuk elemandan buyuk olamaz.
        int ceiling2 = ts.ceiling(25);
        System.out.println(ceiling2);//25==> 25 elemanlardan biri  o yuzden 25 direkt yazdirdi.

        SortedSet<Integer> tailSet1 = ts.tailSet(12);
        System.out.println(tailSet1);//[12, 25, 32]//12==> 12 elemanlardan biri  o yuzden "12 ve sonraki elemanlar" bir Set icinde yazdirdi.

        SortedSet<Integer> tailSet2 = ts.tailSet(15);
        System.out.println(tailSet2);//[25, 32]// ==> 15 elemanlardan biri degil o yuzden 15 den sonraki elemanlar bir set icinde yazdirdi.

        NavigableSet<Integer> tailSet3 = ts.tailSet(12, false);
        System.out.println(tailSet3);//[25, 32]==> 12 elemanlardan biri  o yuzden "12 ve sonraki elemanlar" bir Set icinde yazdirdi.
                                    //ama ikinci parametre'de "false" kullandigim icin 12 haric tutuldu.

        SortedSet<Integer> headSet1 = ts.headSet(12);
        System.out.println(headSet1);//[3, 8]==> 12 elemanlardan biri "onceki elemanlar" bir set icinde yazdirrildi. 12 Yazdirilmadi.

        SortedSet<Integer> headSet2 = ts.headSet(12, true);
        System.out.println(headSet2);//[3, 8, 12]

        //Generic Method: Normal method'lar parametrelerde belirtilen data type'lari ile calisilar.
